...
let directionQueue = [];
const initialGameSpeed = 140; // Initial game speed
let gameSpeed = initialGameSpeed; // Set the initial game speed
...
function initSnakeGame() {
    ...
    gameSpeed = initialGameSpeed; // Reset game speed to initial value
    ...
    if (game) clearInterval(game); // Clear any existing game interval
...
function resizeCanvas() {
    ...
    // Ensure food stays within bounds after resizing
    food = generateFood();

    // Adjust snake positions to fit within new canvas size
...
function drawSnake() {
    for (let i = 0; i < snake.length; i++) {
        ...
        ctx.strokeStyle = '#f00';
        ctx.lineWidth = 1; // Thinner border for the snake
